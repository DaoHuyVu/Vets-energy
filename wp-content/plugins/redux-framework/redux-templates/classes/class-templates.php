...
class Templates {
	...
	public function template_include( $template ) {
		if ( is_singular() ) {
			...
			}elseif ( 'redux-no-display' === $page_template ) {
                $template = REDUXTEMPLATES_DIR_PATH . 'classes/templates/template-no-display.php';
            }
		}
	...
	public function add_templates( $post_templates ) {
		...
		$post_templates['redux-no-display']     = __( 'Redux no display', 'redux-framework' );
