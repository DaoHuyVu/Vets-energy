<?php
    $args = array_merge( $wp_query->query_vars, array( 'category__in' => $category["id"] ) );
    query_posts( $args  );
?>
...
<div id="training" class="category">
    ...
    $cat_tintuc_id = pll_get_term( 290 );
    $cat_tintuc = ami_theme_get_category_by_id($cat_tintuc_id);

    ?>
    <?php if ($latest_post && isset($cat_tintuc) && !empty($cat_tintuc) ) : ?>
                ...
                <div class="position-relative">
                    ...
                    <div class="container position-absolute">
                        <div class="main-info">
                            ...
                            <a href="<?php echo esc_url( $cat_tintuc['url'] ); ?>" class="btn btn-primary text-uppercase"><?php echo __('Xem thêm', 'vetsenergy'); ?></a>
                        </div>
                    </div>
                </div>
            </div>
